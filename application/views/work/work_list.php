                ...
                axios.post("/work/search/" + page, {
                    ...
                    switch (result.data.status) {
                        case 200:
                            ...
                            el._data.pages.splice();
                            el._data.pages = result.data.pages;
                            break;
                        case 300:
                            break;
                    }
                        ...
                        case 200:
                            switch (type) {
                                case 'user_check_date':
                                    el._data.requests[index].check_user = result.data.check_user;
                                    el._data.requests[index].user_check_date = result.data.content;
                                    break;
                                case 'common_date':
                                    el._data.requests[index].common_check_user = result.data.common_check_user;
